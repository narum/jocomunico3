...
class AddWordInterface extends CI_Model {
    ...
    function getDBVerbs(){
        ...
        $this->db->select('verbid as id, PictogramsLanguage.pictotext as text, Pictograms.pictoType as type');
    ...
    function getDBNamesLike($startswith, $user) {
        ...
        $this->db->select('nameid as id, PictogramsLanguage.pictotext as text, Pictograms.pictoType as type, imgPicto, imgFolder, Pictograms.ID_PUser'); // rename the field like we want
