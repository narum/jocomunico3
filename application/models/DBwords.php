...
class DBwords extends CI_Model {
    ...
    function getDBNamesLike($startswith, $user)
    {
        ...
        $this->db->select('nameid as id, PictogramsLanguage.pictotext as text, imgPicto, imgFolder, Pictograms.ID_PUser');// rename the field like we want
   ...
   /*
    ...
    function getDBVerbsLike($startswith, $user)
    {
        ...
        $this->db->select('verbid as id, PictogramsLanguage.pictotext as text, imgPicto, imgFolder');
    ...
    function getDBAdjLike($startswith, $user)
    {
        ...
        $this->db->where_in('Pictograms.ID_PUser', array('1',$user));
        $this->db->where('PictogramsLanguage.languageid', $languageInt);//Get all default and own user pictos
        $this->db->select('adjid as id,PictogramsLanguage.pictotext as text, imgPicto, imgFolder');
    ...
    function getDBExprsLike($startswith, $user)
    {
        ...
        $this->db->where_in('Pictograms.ID_PUser', array('1',$user));
        $this->db->where('PictogramsLanguage.languageid', $languageInt); //Get all default and own user pictos
        $this->db->select('exprid as id, PictogramsLanguage.pictotext as text, imgPicto, imgFolder');
    ...
    function getDBAdvsLike($startswith, $user)
    {
        ...
        $this->db->where_in('Pictograms.ID_PUser', array('1',$user));
        $this->db->where('PictogramsLanguage.languageid', $languageInt); //Get all default and own user pictos
        $this->db->select('advid as id, PictogramsLanguage.pictotext as text, imgPicto, imgFolder');
    ...
    function getDBModifsLike($startswith, $user)
    {
        ...
        $this->db->where_in('Pictograms.ID_PUser', array('1',$user));
        $this->db->where('PictogramsLanguage.languageid', $languageInt); //Get all default and own user pictos
        $this->db->select('modid as id, PictogramsLanguage.pictotext as text, imgPicto, imgFolder');
    ...
    function getDBQuestionPartLike($startswith, $user)
    {
        ...
        $this->db->where_in('Pictograms.ID_PUser', array('1',$user));
        $this->db->where('PictogramsLanguage.languageid', $languageInt);  //Get all default and own user pictos
        $this->db->select('questid as id, PictogramsLanguage.pictotext as text, imgPicto, imgFolder');
